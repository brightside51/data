...
def data_parser(
    ...
    # Fundamentals | Dataset Definition
    ...
    parser.add_argument('--base_fp', type = str,
                        default = f"X:/nas-ctm01/homes/pfsousa/data")
    ...
    if save_fp.exists():
        ...
        with open(save_fp, "r") as f: args_save = json.load(f)
        args = argparse.Namespace(**args_save)
    else:
    ...
    # ============================================================================================
        ...
        # Dataset | Dataset Fundamental Arguments
